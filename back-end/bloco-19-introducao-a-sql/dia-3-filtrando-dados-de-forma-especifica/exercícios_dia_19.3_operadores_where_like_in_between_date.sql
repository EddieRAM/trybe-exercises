#Exercícios dia 19/3 -- Operadores WHERE, LIKE, IN, BETWEEN, DATE
...
# 5. Escreva uma query para exibir o número de empresas (fornecedores) que contém a letra F
-- no código.
...
# 7. Escreva uma query para exibir o número de vendas feitas entre o dia 15/04/2018 
-- e o dia 30/07/2019.
